...
{
    public enum SegmentType : byte // https://github.com/kevinburke/rct/blob/master/tracks/segment.go
    {
         ELEM_FLAT                              			= 0,
        ...
        // category as a water feature/rapids/photo,
         ...
         ELEM_MINI_GOLF_HOLE_A                            = 0xC9,
         ELEM_MINI_GOLF_HOLE_B                            = 0xCA,
         ELEM_MINI_GOLF_HOLE_C                            = 0xCB,
         ELEM_MINI_GOLF_HOLE_D                            = 0xCC,
         ELEM_MINI_GOLF_HOLE_E                            = 0xCD,
         ...
         ELEM_LEFT_REVERSER                               = 0xD3,
         ELEM_RIGHT_REVERSER                              = 0xD4,
         ELEM_AIR_THRUST_TOP_CAP                          = 0xD5,
         ELEM_AIR_THRUST_VERTICAL_DOWN                    = 0xD6,
         ELEM_AIR_THRUST_VERTICAL_DOWN_TO_LEVEL           = 0xD7,
